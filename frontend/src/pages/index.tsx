  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover Restaurant Booking Engine, your ultimate solution for seamless table reservations and efficient restaurant management. Empowering customers and employees alike."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover Restaurant Booking Engine, your ultimate solution for seamless table reservations and efficient restaurant management. Empowering customers and employees alike.`}
            </Text>
            <Box
